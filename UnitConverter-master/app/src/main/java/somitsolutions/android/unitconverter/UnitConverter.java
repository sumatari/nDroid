...
public class UnitConverter extends Activity implements OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputValue2 = (EditText)findViewById(R.id.EditTextValue2);
        ...
        if(v.getParent() == SpinnerUnit){
            ...
            switch(position){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    setStrategy( new HeightStrategy());
                    break;
    ...
    private void fillSpinnerWithHeightUnit(){
        unitarrayadapter.clear();
        unitarrayadapter.add(getResources().getString(R.string.heightunitfeet));
        unitarrayadapter.add(getResources().getString(R.string.heightunitcm));
    ...
    public void onClick(View v){
        if(v == ButtonConvert){
            if(!inputValue.getText().toString().equals("")){
                ...
                double in2 = Double.parseDouble(inputValue2.getText().toString());
                double result = currentStrategy.Convert(unitfrom, unitto, in, in2);
