...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button analyze2=(Button) findViewById(R.id.analyze2);
        final TextView traits= (TextView)findViewById(R.id.traits);
        final TextView traits2= (TextView)findViewById(R.id.traits2);

        analyze.setOnClickListener (new View.OnClickListener() {

        @Override
        public void onClick (View v) {
        traits.setText("Your personality traits are as:");
        traits2.setText("Optimist, Strong, Sensitive ");
            analyze2.setVisibility(View.VISIBLE);
        }
        } );


        analyze2.setOnClickListener (new View.OnClickListener() {

            @Override
            public void onClick (View v) {

               //Switch to new scene and bring the quiz on
            }
        } );
